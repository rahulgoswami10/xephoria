					...
					<div class="main-menu-wrapper">
						...
						<ul class="main-nav">
							...
							<li class="has-submenu active">
								<a href="#">Dashboard <i class="isax isax-add"></i></a>
								<ul class="submenu">
									<li class="has-submenu">
			...
			<div class="container">
							...
							<div class="d-flex align-items-center flex-wrap gap-3">
								...
								<div>
									<h5 class="mb-1 text-white d-inline-flex align-items-center"><a
											href="student-details.html">Ronald Richard</a><a
				...
				<div class="row">
					...
					<div class="col-lg-3 theiaStickySidebar">
						<div class="settings-sidebar">
							<div>
								...
								<ul class="mb-3 pb-1">
									<li>
										<a href="student-courses.html" class="d-inline-flex align-items-center">
					...
					<div class="col-lg-9">
						<div class="card bg-light quiz-ans-card">
							...
							<div class="card-body">
								<div class="row align-items-center">
									...
									<div class="col-md-4">
										<div class="text-end">
											<a href="student-quiz.html" class="btn btn-primary rounded-pill">Continue
												Quiz</a>
										</div>
									</div>
								</div>
						...
						<div>
							<h5 class="fs-18">AI Learning Insights</h5>
							<p class="fs-16">Personalized recommendations based on your progress</p>
							<div class="row justify-content-center">

								<div class="col-md-6 col-xl-4 mb-4">
									<div class="learning-item card-purple h-100">
										<div class="learning-header">
											<div class="learning-icon">
												<i class="isax isax-book-saved"></i>
											</div>
											<span class="badge">On track</span>
										</div>
										<h3 class="text-white fs-18 mb-1">Full Stack Developer Path</h3>
										<p class="text-white fs-14">You are closer to Full Stack Developer</p>
										<div>
											<div class="d-flex justify-content-between align-items-center mb-2">
												<p class="mb-0 text-white fs-16">Progress</p>
												<p class="mb-0 text-white fs-14">70%</p>
											</div>
											<div class="progress progress-xs flex-grow-1">
												<div class="progress-bar bg-white rounded" style="width: 70%"></div>
											</div>
										</div>
									</div>
								</div>
								...
								<div class="col-md-6 col-xl-4 mb-4">
									<div class="learning-item card-magenta h-100">
										<div class="learning-header">
											<div class="learning-icon">
												<i class="isax isax-trend-up"></i>
											</div>
											<span class="badge">React Masterclass</span>
										</div>
										<h3 class="text-white fs-18 mb-1">Next Up for You</h3>
										<p class="text-white fs-14">Advanced React Hooks & Patterns</p>
										<a href="course-details.html"
											class="btn btn-white d-inline-flex align-items-center justify-content-center rounded-pill me-2">
											View Course <i class="isax isax-arrow-right-3"></i>
										</a>
									</div>
								</div>
								...
								<div class="col-md-6 col-xl-4 mb-4">
									<div class="learning-item card-blue h-100">
										<div class="learning-header">
											<div class="learning-icon">
												<i class="isax isax-message-question"></i>
											</div>
											<span class="badge">Based on Web progress</span>
										</div>
										<h3 class="text-white fs-18 mb-1">Recommended for You</h3>
										<p class="text-white fs-14">Node.js API Development</p>
										<a href="course-details.html"
											class="btn btn-white d-inline-flex align-items-center justify-content-center rounded-pill me-2">
											View Course <i class="isax isax-arrow-right-3"></i>
										</a>
									...
									<div class="card-body">
										...
										<div
											...
											<div>
												...
												<div class="d-flex align-items-center gap-2">
													<p class="mb-0">#INV001</p>
													<i class="fa-solid fa-circle dot-icon"></i>
													<p>Amount : <span class="heading-color text-info">$200</span></p>
												</div>
											</div>

											<div class="d-flex align-items-center">
												<span
													class="badge fw-normal bg-success d-inline-flex align-items-center me-1"><i
										...
										<div
											...
											<div>
												...
												<div class="d-flex align-items-center gap-2">
													<p class="mb-0">#INV002</p>
													<i class="fa-solid fa-circle dot-icon"></i>
													<p>Amount : <span class="heading-color text-info">$310</span></p>
												</div>
											</div>
											<div class="d-flex align-items-center">
												<span
										...
										<div
											...
											<div>
												...
												<div class="d-flex align-items-center gap-2">
													<p class="mb-0">#INV003</p>
													<i class="fa-solid fa-circle dot-icon"></i>
													<p>Amount : <span class="heading-color text-info">$270</span></p>
												</div>
											</div>
											<div class="d-flex align-items-center">
												<span
										...
										<div
											...
											<div>
												...
												<div class="d-flex align-items-center gap-2">
													<p class="mb-0">#INV004</p>
													<i class="fa-solid fa-circle dot-icon"></i>
													<p>Amount : <span class="heading-color text-info">$180</span></p>
												</div>
											</div>
											<div class="d-flex align-items-center">
												<span
										...
										<div
											...
											<div>
												...
												<div class="d-flex align-items-center gap-2">
													<p class="mb-0">#INV005</p>
													<i class="fa-solid fa-circle dot-icon"></i>
													<p>Amount : <span class="heading-color text-info">$220</span></p>
												</div>
											</div>
											<div class="d-flex align-items-center">
												<span
									...
									<div class="card-body">
										...
										<div
											...
											<div>
												...
												<div class="d-flex align-items-center gap-2 flex-wrap">
													<p class="mb-0">Correct Answer : 15/22</p>
													<i class="fa-solid fa-circle dot-icon"></i>
													<p>Date : 15 Jan 2026</p>
												</div>
											</div>
										...
										<div
											...
											<div>
												<h6 class="mb-1">Sketch from A to Z (2024)</h6>
												<div class="d-flex align-items-center gap-2 flex-wrap">
													<p class="mb-0">Correct Answer : 18/22</p>
													<i class="fa-solid fa-circle dot-icon"></i>
													<p>Date : 04 Jan 2026</p>
												</div>
											</div>
										...
										<div
											...
											<div>
												<h6 class="mb-1">Sketch from A to Z (2024)</h6>
												<div class="d-flex align-items-center gap-2 flex-wrap">
													<p class="mb-0 text-nowrap">Correct Answer : 25/30</p>
													<i class="fa-solid fa-circle dot-icon"></i>
													<p class="text-nowrap">Date : 26 Dec 2026</p>
												</div>
											</div>
										...
										<div
											...
											<div>
												<h6 class="mb-1">Sketch from A to Z (2024)</h6>
												<div class="d-flex align-items-center gap-2 flex-wrap">
													<p class="mb-0">Correct Answer : 15/20</p>
													<i class="fa-solid fa-circle dot-icon"></i>
													<p>Date : 10 Dec 2026</p>
												</div>
											</div>
										...
										<div
											...
											<div>
												<h6 class="mb-1">Sketch from A to Z (2024)</h6>
												<div class="d-flex align-items-center gap-2 flex-wrap">
													<p class="mb-0">Correct Answer : 12/20</p>
													<i class="fa-solid fa-circle dot-icon"></i>
													<p>Date : 27 Nov 2026</p>
												</div>
											</div>
							...
							<div class="col-xl-4 col-md-6">
								<div class="course-item-two course-item mb-0">
									...
									<div class="course-content">
										...
										<h6 class="title mb-2"><a href="course-details.html">Information About UI/UX
												Design Degree</a></h6>
									...
									<div class="course-content">
										<div class="d-flex justify-content-between mb-2">
											<div class="d-flex align-items-center">
												...
												<div class="ms-2">
													<a href="instructor-details.html" class="link-default fs-14">Ana
														Reyes</a>
												</div>
											</div>
											<span
										...
										<h6 class="title mb-2"><a href="course-details.html">Wordpress for Beginners -
									...
									<div class="course-content">
										<div class="d-flex justify-content-between mb-2">
											<div class="d-flex align-items-center">
												...
												<div class="ms-2">
													<a href="instructor-details.html" class="link-default fs-14">Andrew
														Pirtle</a>
												</div>
											</div>
											<span
										...
										<h6 class="title mb-2"><a href="course-details.html">Sketch from A to Z (2024):
