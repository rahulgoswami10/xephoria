...
<!-- Mirrored from dreamslms.dreamstechnologies.com/html/template/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jun 2026 20:52:12 GMT -->
...
<head>
	...
	<body><a href="../../cdn-cgi/content423e.html?id=8SiUIKxD45G19c3Z2BY96k2jBSRoAQ8AsFKA8NvRfcY-1780432722.0861692-1.0.1.1-pZ4JIi5bxjUAY4Z3VO9etHDu3.byoNSmY1Be66ddLzs" aria-hidden="true" rel="nofollow noopener" style="display: none !important; visibility: hidden !important"></a>
                            ...
                            <div>
                                <div class="login-carousel-section mb-3">
                                    ...
                                    <div class="mentor-course text-center">
                                        <h3 class="mb-2">Welcome to <br><span class="text-secondary">Xephoria LMS</span> Courses.</h3>
                        ...
                        <div class="login-wrapper">
                            <div class="loginbox">
                                <div class="w-100">
                                    ...
                                    <form action="formaction.php" method="post" class="mb-3 pb-3" enctype="multipart/form-data">
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <div class="position-relative">
                                                ...
                                                <span>
                                                    <i class="isax isax-call input-icon text-gray-7 fs-14"></i>
                                                </span>
                                            </div>
                                        </div>
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <div class="position-relative" id="passwordInput">
                                                <input type="password" class="pass-inputs form-control form-control-lg" name="password">
                                        ...
                                        <div class="mb-3 position-relative">
                                            ...
                                            <div class="position-relative">
                                                <input type="password" class="pass-inputa form-control form-control-lg" name="confirm_password">
                                        ...
                                        <!-- signup button -->
                                        <div class="d-grid">
                                            <button class="btn btn-secondary btn-lg" type="submit" name="register">
                                    ...
                                    <div class="fs-14 fw-normal d-flex align-items-center justify-content-center">
                                        Already you have an account?<a href="login.php" class="link-2 ms-1"> Login</a>
                                    </div>
	   ...
	   <!-- /Main Wrapper -->
		...
		<!-- jQuery -->
		<script src="../assets/js/jquery-3.7.1.min.js" type="4639aa4f0878511094a4180f-text/javascript"></script>
		
		<!-- Bootstrap Core JS -->
		<script src="../assets/js/bootstrap.bundle.min.js" type="4639aa4f0878511094a4180f-text/javascript"></script>
		
		<!-- Select2 JS -->
	  	<script src="../assets/plugins/select2/js/select2.min.js" type="4639aa4f0878511094a4180f-text/javascript"></script>

        <!-- Slick Slider -->
		<script src="../assets/plugins/slick/slick.js" type="4639aa4f0878511094a4180f-text/javascript"></script>

        <!-- Validation-->
		<script src="../assets/js/validation.js" type="4639aa4f0878511094a4180f-text/javascript"></script>	
		
		<!-- Custom JS -->
		<script src="../assets/js/script.js" type="4639aa4f0878511094a4180f-text/javascript"></script>
		
	<script src="../../cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="4639aa4f0878511094a4180f-|49" defer></script></body>

<!-- Mirrored from dreamslms.dreamstechnologies.com/html/template/register.html by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 02 Jun 2026 20:52:13 GMT -->
</html>